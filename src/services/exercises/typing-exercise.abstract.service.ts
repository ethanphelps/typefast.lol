...
// import { WordComponentData as WordData } from "../../components/TypingArea";
...
//     private wordComponents: WordData[] = [];
//     private setWordComponents: React.Dispatch<React.SetStateAction<WordData[]>> = () => { };
...
//         setWordComponents: React.Dispatch<React.SetStateAction<WordData[]>>, // TODO: move setWordComponents to TypingArea
...
//      */
//     protected updateWordComponents (correct: boolean): WordData[] {
...
//     protected setNextHighlightedWord (wordComponents: WordData[]) {
...
//      */
//     protected getWordComponentList (selectedWords: string[]): WordData[] {
